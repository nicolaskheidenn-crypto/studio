    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#1f1610] text-[#fdfaf6] p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-2xl space-y-12 animate-in slide-in-from-bottom-20 duration-1000 relative z-10">
        <div className="text-center space-y-8">
          <div className="p-10 bg-[#FFD700]/20 rounded-[4rem] w-fit mx-auto border-8 border-[#FFD700]/20 shadow-[0_0_100px_rgba(255,215,0,0.1)]">
            <Lock className="h-20 w-20 text-[#FFD700]" />
          </div>
          <div className="space-y-4">
            <h2 className="text-6xl font-headline font-black tracking-tight text-[#fdfaf6] uppercase italic">Master Access</h2>
        ...
        <form onSubmit={verifyKey} className="space-y-12 bg-[#1f1610]/80 p-16 rounded-[4rem] border-8 border-[#FFD700]/10 shadow-2xl backdrop-blur-xl">
          <div className="space-y-6">
            <Label className="text-[#FFD700] text-xs font-black uppercase tracking-[0.3em] ml-2">16-Digit Protocol Key</Label>
            <Input
              type="text"
              placeholder="0000-0000-0000-0000"
              className="bg-black/40 border-8 border-[#FFD700]/20 h-28 text-center text-4xl font-mono tracking-[0.2em] rounded-[2rem] focus:border-[#FFD700] text-[#fdfaf6] shadow-inner font-black"
              value={key}
          ...
          <Button
            type="submit"
            className="w-full h-28 rounded-[2rem] bg-[#FFD700] text-[#1f1610] hover:bg-[#fdfaf6] hover:text-[#1f1610] font-black text-3xl shadow-[0_30px_60px_rgba(255,215,0,0.3)] transition-all active:scale-95 uppercase tracking-tighter"
